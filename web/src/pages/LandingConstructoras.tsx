      ...
      <header className="sticky top-0 z-50 border-b border-border/30 bg-background/80 backdrop-blur-xl">
        <div className="mx-auto max-w-7xl flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link to="/constructoras" className="rounded-full bg-blue-500 text-white px-5 py-2.5 text-xs font-bold hover:bg-blue-600 transition-colors">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-24 pb-20 sm:pt-32 sm:pb-28">
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            ...
            <div className="space-y-6">
              <div className="inline-flex items-center gap-2 rounded-full border border-blue-500/20 bg-blue-500/5 px-4 py-1.5 text-xs font-medium text-blue-600">
                <LiveDot color="blue" />
              ...
              <div className="flex flex-wrap gap-3">
                <Link
                  to="/constructoras"
                  className="inline-flex items-center gap-2 rounded-full bg-blue-500 text-white px-8 py-4 text-base font-bold hover:bg-blue-600 hover:scale-[1.03] transition-all shadow-lg shadow-blue-500/25"
                >
      ...
      <section id="features" className="border-t border-border/30 bg-card/10">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center mb-14">
            <p className="text-xs uppercase tracking-[0.25em] text-blue-600 font-bold mb-3">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              <div
                key={item.step}
                className="relative group rounded-2xl border border-black/[0.06] bg-white shadow-sm p-6 transition-all hover:shadow-xl hover:shadow-blue-500/10"
              >
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-6">
              ...
              <Link to="/" className="text-xs text-blue-600 hover:text-blue-300 transition-colors">Inicio</Link>
            </div>
          </div>
        </div>
      </footer>
