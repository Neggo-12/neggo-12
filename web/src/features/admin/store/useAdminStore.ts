...
interface AdminState {
  ...
  activeSection: 'resumen' | 'autorizaciones' | 'bancos' | 'constructoras' | 'comercios' | 'clientes' | 'analitica' | 'estadisticas' | 'facturacion' | 'tarifas' | 'puntos' | 'conciliacion' | 'senales-interes' | 'seguridad' | 'salud-sistema' | 'auditoria' | 'crm-ventas';
