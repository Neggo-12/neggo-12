...
| **Colabora con** | Product Marketing (mensaje validado por audiencia), Growth (qué prospectos calentar con qué pieza), Datos (métricas de cada post). |
| **Frecuencia** | Sesión de producción semanal en lote (ej. domingos, ya sugerido en el plan) + ajustes puntuales. |
